            ...
            <div className="mx-auto max-w-7xl px-6 pt-36 pb-32 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="mt-8 text-lg font-medium text-pretty text-justify text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">
                    Greenwich Theatre is one of London’s foremost Off-West End
                    theatres, working on a local, national and international
                    stage. From presenting an enviable year-round programme of
                    established and emerging theatre here in the Royal borough
                    of Greenwich, to supporting artists in taking their work
                    around the world, the development of new work is always at
                    the heart of what we do. Combined with our nationally
                    regarded programme of theatre for children and young people
                    and our award-winning pantomime, Greenwich Theatre continues
                    to contribute to this country’s dynamic, diverse, vibrant
                    theatre ecology, treating the audiences of today to a
                    glimpse of some of the biggest theatre-makers of tomorrow.
                  </p>
                </div>
      ...
      <footer className="mt-16 sm:mt-32">
        <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
          ...
          <p className="mt-10 text-center text-sm/6 text-gray-600">
            &copy; 2025 Greenwich Theatre. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
